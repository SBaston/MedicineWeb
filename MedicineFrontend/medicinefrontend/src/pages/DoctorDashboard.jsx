...
import {
    ...
    MessageCircle, ShieldCheck, ShieldAlert, KeyRound, Copy, ScanLine, X, Globe
} from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 mb-6">
                    ...
                    <QuickActionCard
                        icon={MessageCircle}
                        title="Mis chats"
                        description="Chats con pacientes"
                    ...
                    <QuickActionCard
                        ...
                        description="Gestiona tus redes"
                        onClick={() => navigate('/doctor/social-media')}
                        color="teal"
                    />
                    <QuickActionCard
                        icon={Users}
